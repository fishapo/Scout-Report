    ...
    async function runQuery(text, params = []) {
        ...
        */
        ...
        throw new Error(
            ...
            `Unhandled SQL in auth test mock: ${sql}`
...
test(
"hashPassword stores a non plaintext hash and verifyPassword validates it",
async()=>{
...
test(
"registerUser creates first user as admin and rejects weak passwords",
async()=>{
...
test(
"loginUser issues JWT session and logout revokes it",
async()=>{
...
test(
"authorizeRoles rejects authenticated users without required role",
async()=>{
